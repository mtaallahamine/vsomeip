...
then
    ...
    echo "For example: $0 e2e_test_client_external.json"
    exit 1
fi
...
** e2e_test_service_external.json and
** e2e_test_client_external.json to your personal setup.
*******************************************************************************
*******************************************************************************
End-of-message
fi
